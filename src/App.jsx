  ...
  return (
    <>
      <nav>
        ...
        <div className='divNav'>
          <div className='divSolde'>
            ...
            <span className='monSoldeNombre'>{solde}$</span>
          </div>
        ...
        <Panier panier={panier} setPanier={setPanier} panierOuvert={panierOuvert} setPanierOuvert={setPanierOuvert} />
      </nav>
      <header>
      ...
      <main>
        ...
        {data.map(element => (
          <Produit panier={panier} setPanier={setPanier} solde={solde} setSolde={setSolde} key={element.id} id={element.id} title={element.title} description={element.description} image={element.image} prix={element.prix} stock={element.stock} />
        ))}
        </div>
      </main>
      <footer>
