...
function App() {
  ...
  const [stocks, setStocks] = useState(()=> {
    const stockInitial = {}
    data.forEach(item => {
      stockInitial[item.id] = item.stock
  ...
  return (
    <>
      <nav>
        ...
        <Panier stocks={stocks} setStocks={setStocks} solde={solde} setSolde={setSolde} total={total} setTotal={setTotal} data={data} panier={panier} setPanier={setPanier} panierOuvert={panierOuvert} setPanierOuvert={setPanierOuvert} />
      </nav>
      <header>
      ...
      <main>
        ...
        {data.map(element => (
          <Produit stocks={stocks} setStocks={setStocks} total={total} setTotal={setTotal} panier={panier} setPanier={setPanier} solde={solde} setSolde={setSolde} key={element.id} id={element.id} title={element.title} description={element.description} image={element.image} prix={element.prix} stock={element.stock} />
        ))}
        </div>
      </main>
      <footer>
